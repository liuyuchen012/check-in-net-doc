import{_ as n,o as a,c as p,a2 as e}from"./chunks/framework.BWuWLRhz.js";const u=JSON.parse('{"title":"目录结构","description":"","frontmatter":{"title":"目录结构"},"headers":[],"relativePath":"miniprogram/structure.md","filePath":"miniprogram/structure.md","lastUpdated":1787575917000}'),l={name:"miniprogram/structure.md"};function i(c,s,t,o,r,d){return a(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>miniprogram-1/</span></span>
