...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" width="100%" height="100%">
  ...
  <path d="M20,90 C35,75 50,105 65,90 C80,75 95,105 110,90 C125,75 140,105 155,90" fill="none" stroke="white" stroke-width="3" opacity="0.2" stroke-linecap="round"/>
  <path d="M48,72 L66,90 L102,52" fill="none" stroke="white" stroke-width="8" stroke-linecap="round" stroke-linejoin="round"/>
</svg>`,Qn={class:"vstage vs-intro"},Xn=["innerHTML"],to=y({__name:"IntroStage",setup(t){return(e,i)=>(n(),c("section",Qn,[o("div",{class:"vs-intro-logo",innerHTML:r(bt)},null,8,Xn),i[0]||(i[0]=R('<h1 class="vs-intro-name">AgoraIn</h1><div class="vs-intro-badge">v2.8 全新版本</div><p class="vs-intro-tag t1">大屏签到 · 课时划消 · 集控平台</p><p class="vs-intro-tag t2">多端协同的现代化课堂管理解决方案</p><p class="vs-intro-hint">宣传片即将开始</p>',5))]))}}),eo={class:"vstage vs-upd"},io={class:"vs-upd-card"},lo=["innerHTML"],so={class:"vs-upd-steps"},no=y({__name:"UpdateStage",setup(t){const e=["下载更新包","校验完整性","安装核心组件","配置本地服务","界面初始化"];return(i,l)=>(n(),c("section",eo,[o("div",io,[o("div",{class:"vs-upd-logo",innerHTML:r(bt)},null,8,lo),l[0]||(l[0]=o("h2",{class:"vs-upd-title"},"正在更新 AgoraIn",-1)),l[1]||(l[1]=o("p",{class:"vs-upd-sub"},"v2.7 → v2.8 · 全新重构",-1)),l[2]||(l[2]=o("div",{class:"vs-upd-bar"},[o("div",{class:"vs-upd-fill"})],-1)),o("div",so,[(n(),c(C,null,I(e,(s,a)=>o("span",{key:s,class:"vs-upd-step",style:q({"--s-delay":3.6+a*2.2+"s"})},M(s),5)),64))]),l[3]||(l[3]=o("div",{class:"vs-upd-done"},[o("span",{class:"vs-upd-check"},"✓"),o("span",null,"核心组件已就绪，全新界面即将呈现")],-1))])]))}}),oo={class:"vstage vs-scr"},ao={class:"vs-scr-wrap"},ro=["innerHTML"],fo=y({__name:"ScreenStage",setup(t){return(e,i)=>(n(),c("section",oo,[i[1]||(i[1]=o("div",{class:"vstage-title"},"大屏模式 · 课堂签到打卡",-1)),i[2]||(i[2]=o("div",{class:"vstage-sub"},"学生点击即签到 · 实时排名 · 迟到一目了然",-1)),o("div",ao,[o("div",{innerHTML:r(Jn)},null,8,ro),i[0]||(i[0]=R('<div class="vs-over s26"><span class="vs-chk">✓</span></div><div class="vs-over s27"><span class="vs-chk">✓</span></div><div class="vs-over s28"><span class="vs-chk">✓</span></div><div class="vs-over s29"><span class="vs-chk">✓</span></div><div class="vs-over s30"><span class="vs-chk">✓</span></div><div class="vs-stat">总人数: 40  |  已打卡: 30  (75%)</div><div class="vs-rank">9   王小明   08:25:01</div><div class="vs-tip">签到实时同步至排名与统计</div>',8))])]))}}),co={class:"vstage vs-ctl"},xo={class:"vs-ctl-wrap"},ho=["innerHTML"],uo=y({__name:"ControlStage",setup(t){return(e,i)=>(n(),c("section",co,[i[1]||(i[1]=o("div",{class:"vstage-title"},"控制模式 · 课时划消与排课",-1)),i[2]||(i[2]=o("div",{class:"vstage-sub"},"选课划课 · 日历排课 · 课时记录自动留存",-1)),o("div",xo,[o("div",{innerHTML:r(Yn)},null,8,ho),i[0]||(i[0]=R('<div class="vs-c-lesson">剩10</div><div class="vs-c-record"><span class="d">2026-08-24</span><span class="m">-2</span><span class="t">数学课</span></div><div class="vs-c-cal">2节</div><div class="vs-c-sched"><span class="n">王五</span><span class="tm">14:00</span><span class="tm">15:00</span><span class="rm">移除</span></div><div class="vs-tip">课时自动划消，排课一目了然</div>',5))])]))}}),vo={},yo={class:"vstage vs-srv"};function go(t,e){return n(),c("section",yo,[...e[0]||(e[0]=[R('<div class="vstage-title">集控服务器 · 多设备集中管理</div><div class="vstage-sub">一台服务器集中管理所有教室设备 · 数据实时同步</div><div class="vs-srv-stage"><svg class="vs-srv-lines" viewBox="0 0 1000 562.5" preserveAspectRatio="none"><line class="vs-srv-line" x1="140" y1="90" x2="700" y2="280"></line><line class="vs-srv-line" x1="140" y1="280" x2="700" y2="280"></line><line class="vs-srv-line" x1="140" y1="470" x2="700" y2="280"></line><circle class="vs-srv-pkt p1" r="7" fill="#22d3ee"><animateMotion dur="2.2s" repeatCount="indefinite" begin="8s" path="M140,90 L700,280"></animateMotion></circle><circle class="vs-srv-pkt p2" r="7" fill="#34d399"><animateMotion dur="2.6s" repeatCount="indefinite" begin="9s" path="M140,280 L700,280"></animateMotion></circle><circle class="vs-srv-pkt p3" r="7" fill="#a78bfa"><animateMotion dur="3s" repeatCount="indefinite" begin="10s" path="M140,470 L700,280"></animateMotion></circle></svg><div class="vs-srv-node nd-a"><span class="ic">🖥️</span><span class="nm">教室 A · 大屏</span><span class="st on">在线</span></div><div class="vs-srv-node nd-b"><span class="ic">🖥️</span><span class="nm">教室 B · 大屏</span><span class="st on">在线</span></div><div class="vs-srv-node nd-c"><span class="ic">📱</span><span class="nm">教室 C · 控制台</span><span class="st on">在线</span></div><div class="vs-srv-core"><div class="vs-srv-core-ic"><svg viewBox="0 0 48 48" width="100%" height="100%"><rect x="6" y="6" width="36" height="14" rx="4" fill="#38bdf8"></rect><rect x="6" y="26" width="36" height="14" rx="4" fill="#38bdf8"></rect><circle cx="14" cy="13" r="2.4" fill="#0b1220"></circle><circle cx="22" cy="13" r="2.4" fill="#0b1220"></circle><circle cx="14" cy="33" r="2.4" fill="#0b1220"></circle><circle cx="22" cy="33" r="2.4" fill="#0b1220"></circle><rect x="30" y="11" width="8" height="4" rx="2" fill="#fff"></rect><rect x="30" y="31" width="8" height="4" rx="2" fill="#fff"></rect></svg></div><div class="vs-srv-core-name">AgoraIn 集控服务器</div><div class="vs-srv-core-port">端口 5250 · 数据实时同步</div><div class="vs-srv-core-stats"><div class="st"><span class="v">6</span><span class="l">设备总数</span></div><div class="st"><span class="v on2">6</span><span class="l">在线设备</span></div><div class="st"><span class="v">12</span><span class="l">任务总数</span></div></div></div><div class="vs-tip">设备状态 · 任务下发 · 签到数据，统一汇聚</div></div>',3)])])}const mo=_(vo,[["render",go]]),po={},ko={class:"vstage vs-mob"};function wo(t,e){return n(),c("section",ko,[...e[0]||(e[0]=[R('<div class="vstage-title">移动多端应用</div><div class="vstage-sub">随时随地签到与管理 · 与桌面端数据实时同步</div><div class="vs-mob-row"><div class="vs-mob-card mp"><div class="vs-mob-icon mp-ic"><svg viewBox="0 0 48 48" width="100%" height="100%"><circle cx="17" cy="19" r="6" fill="#fff" opacity="0.95"></circle><circle cx="31" cy="19" r="6" fill="#fff" opacity="0.95"></circle><path d="M13 34 Q 9 28 13 25 Q 17 22 21 25 L 27 28 Q 31 31 27 34 Z" fill="#fff"></path><path d="M14 17 a1.8 1.8 0 1 0 0.01 0 M28 17 a1.8 1.8 0 1 0 0.01 0" stroke="#07c160" stroke-width="2" fill="none"></path></svg></div><div class="vs-mob-name">微信小程序</div><p class="vs-mob-desc">学生扫码即签到<br>无需安装</p></div><div class="vs-mob-card apk"><div class="vs-mob-icon apk-ic"><svg viewBox="0 0 48 48" width="100%" height="100%"><path d="M8 22 C8 14 14 8 24 8 C34 8 40 14 40 22 L40 34 C40 37 38 40 34 40 L14 40 C10 40 8 37 8 34 Z" fill="#34d399"></path><path d="M14 16 L34 16 M14 16 C13 20 13 24 14 28 M34 16 C35 20 35 24 34 28" stroke="#0b1220" stroke-width="2.4" stroke-linecap="round"></path><circle cx="17" cy="24" r="1.8" fill="#0b1220"></circle><circle cx="31" cy="24" r="1.8" fill="#0b1220"></circle><path d="M20 36 L24 30 L28 36" stroke="#0b1220" stroke-width="2.4" fill="none" stroke-linecap="round" stroke-linejoin="round"></path></svg></div><div class="vs-mob-name">Android 客户端</div><p class="vs-mob-desc">设备控制与集控管理<br>随身携带</p></div></div><div class="vs-mob-feats"><div class="f f1"><span class="dot"></span>学生移动端签到打卡</div><div class="f f2"><span class="dot"></span>课时余额与排课查看</div><div class="f f3"><span class="dot"></span>设备状态实时监控</div></div><div class="vs-mob-sync">桌面端 / 小程序 / Android 数据实时同步</div>',5)])])}const _o=_(po,[["render",wo]]),bo={class:"vstage vs-out"},$o=["innerHTML"],Lo=y({__name:"OutroStage",setup(t){return(e,i)=>(n(),c("section",bo,[o("div",{class:"vs-out-logo",innerHTML:r(bt)},null,8,$o),i[0]||(i[0]=R('<h2 class="vs-out-title">让课堂管理更简单</h2><p class="vs-out-sub">AgoraIn v2.8 全新发布</p><div class="vs-out-links"><span class="l">doc.615mc.cn</span><span class="sep">·</span><span class="l">文档中心</span><span class="sep">·</span><span class="l">下载中心</span></div><p class="vs-out-copy">© 2026 AgoraIn · GNU GPL v3</p>',4))]))}}),zo={class:"vshow"},Po={class:"vshow-particles","aria-hidden":"true"},Mo={class:"vshow-stage"},So={key:0,class:"vshow-tool"},Vo={class:"vshow-clock"},Co=y({__name:"VideoShowcase",setup(t){const e=[{id:"intro",dur:10},{id:"update",dur:24},{id:"screen",dur:36},{id:"control",dur:36},{id:"server",dur:26},{id:"mobile",dur:18},{id:"outro",dur:14}],i=e.reduce((v,$)=>v+$.dur,0),l=[];let s=0;e.forEach(v=>{l.push(s),s+=v.dur});const a=P(0),f=P(0),x=P(!0),h=[];let w;const L=v=>`${String(Math.floor(v/60)).padStart(2,"0")}:${String(Math.floor(v%60)).padStart(2,"0")}`,p=()=>{h.forEach(v=>window.clearTimeout(v)),h.length=0,w&&window.clearInterval(w),a.value=0,f.value=0,w=window.setInterval(()=>{f.value=Math.min(f.value+1,i)},1e3),e.forEach((v,$)=>{$!==0&&h.push(window.setTimeout(()=>{a.value=$},l[$]*1e3))})};return E(p),yt(()=>{h.forEach(v=>window.clearTimeout(v)),w&&window.clearInterval(w)}),(v,$)=>(n(),c("div",zo,[$[1]||($[1]=o("div",{class:"vshow-bg"},null,-1)),o("div",Po,[(n(),c(C,null,I(14,S=>o("i",{key:S,style:q({"--p-delay":S*.9+"s","--p-x":S*7.3%100+"%","--p-size":3+S%5*2+"px"})},null,4)),64))]),o("div",Mo,[k(K,{name:"v-fade",mode:"out-in"},{default:u(()=>[a.value===0?(n(),m(to,{key:"intro"})):a.value===1?(n(),m(no,{key:"update"})):a.value===2?(n(),m(fo,{key:"screen"})):a.value===3?(n(),m(uo,{key:"control"})):a.value===4?(n(),m(mo,{key:"server"})):a.value===5?(n(),m(_o,{key:"mobile"})):(n(),m(Lo,{key:"outro"}))]),_:1})]),x.value?(n(),c("div",So,[o("span",Vo,M(L(f.value))+" / "+M(L(r(i))),1),o("button",{class:"vshow-btn",type:"button",onClick:p},"↻ 重播"),o("button",{class:"vshow-btn",type:"button",onClick:$[0]||($[0]=S=>x.value=!1)},"隐藏")])):g("",!0)]))}}),Io={extends:Ot,Layout:Kn,enhanceApp({app:t}){t.component("VideoShowcase",Co)}};export{Io as R,vs as c,z as u};
