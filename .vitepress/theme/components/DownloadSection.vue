...
<template>
  <div class="download-section">
    ...
    <div class="download-cards">
      ...
      >
        ...
        <div class="file-meta">
          ...
          <span v-if="item.password" class="file-password">🔑 访问密码 {{ item.password }}</span>
    ...
    <!-- GitHub 入口 -->
    <div class="git-entry">
      <a class="download-btn git-btn" :href="releaseUrl" target="_blank" rel="noopener">
        <span>📋 查看更新详情</span>
      </a>
    </div>
...
.download-card .file-meta .file-password {
  color: var(--vp-c-warning-1);
}
.download-card .file-meta .file-size {
  margin-left: auto;
  flex-shrink: 0;
}
.download-btn {
